...
const translations = {
  en: {
    ...
    "info.ownershipText": "Your session entries stay in this browser. Magpie Studios does not receive or store your tracker log unless you choose to send information through support or chat.",
    ...
    "cookie.text": "We use Google Analytics, with your consent, to count aggregate visits and improve this page. Affiliate links may earn Magpie Studios LLC a commission. See the tracker privacy statement for details.",
    ...
    chatPrivacy: "Your entries are stored locally in this browser with localStorage. Magpie Studios does not receive or store your session log. Do not put sensitive medical details into chat or support messages.",
  ...
  es: {
    ...
    "info.ownershipText": "Tus registros de sesiones se quedan en este navegador. Magpie Studios no recibe ni guarda tu bitacora del tracker a menos que decidas enviar informacion por soporte o chat.",
    ...
    "cookie.text": "Usamos Google Analytics, con tu consentimiento, para contar visitas agregadas y mejorar esta pagina. Los enlaces de afiliado pueden generar una comision para Magpie Studios LLC. Consulta la declaracion de privacidad del tracker para mas detalles.",
    ...
    chatPrivacy: "Tus entradas se guardan localmente en este navegador con localStorage. Magpie Studios no recibe ni guarda tu bitacora de sesiones. No pongas detalles medicos sensibles en mensajes de chat o soporte.",
