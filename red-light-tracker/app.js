...
const translations = {
  en: {
    ...
    "hero.lede": "Log sessions, symptom changes, device settings, and consistency without turning your health notes into a spreadsheet.",
    "hero.start": "Start logging",
    "hero.shop": "Shop NovaaLab",
    "hero.protocol": "Tailbone protocol",
    ...
    "form.painBefore": "Pain before",
    "form.painAfter": "Pain after",
    "form.notes": "Notes",
    "form.notesPlaceholder": "What changed? Sitting tolerance, flare triggers, setup, or anything worth remembering.",
    ...
    "recent.clear": "Clear",
    "info.protocolsTitle": "Track protocols",
    "info.protocolsText": "Save the body area, device, wavelength, distance, duration, and before/after symptom score for each session.",
    ...
    "shop.text": "NovaaLab offers accessible red light therapy products. Use your own judgment, read product details carefully, and talk to a qualified clinician for persistent or severe symptoms.",
    ...
    chatNoSessions: "You have no saved sessions yet. Start with one simple entry: body area, duration, distance, pain before, pain after, and one note about how sitting or movement felt.",
    ...
    chatLog: "For a useful entry, log body area, duration, distance, wavelength if known, pain before and after, and one note about function: sitting tolerance, flare triggers, sleep, exercise, or skin response.",
    chatHow: "Start with one body area and keep the protocol consistent for a few sessions: same device, similar distance, similar duration, and honest before/after scores. Consistency makes your trend chart more meaningful.",
  ...
  es: {
    ...
    "hero.lede": "Registra sesiones, cambios de síntomas, ajustes del dispositivo y constancia sin convertir tus notas de salud en una hoja de cálculo.",
    "hero.start": "Empezar registro",
    "hero.shop": "Comprar NovaaLab",
    "hero.protocol": "Protocolo de coxis",
    ...
    "tracker.title": "Registrar tratamiento",
    ...
    "form.painBefore": "Dolor antes",
    "form.painAfter": "Dolor después",
    "form.notes": "Notas",
    "form.notesPlaceholder": "¿Qué cambió? Tolerancia al sentarte, detonantes, configuración o algo que quieras recordar.",
    "body.tailbone": "Coxis",
    ...
    "recent.clear": "Borrar",
    "info.protocolsTitle": "Registra protocolos",
    "info.protocolsText": "Guarda zona del cuerpo, dispositivo, longitud de onda, distancia, duración y puntuación de síntomas antes/después de cada sesión.",
    ...
    "shop.text": "NovaaLab ofrece productos accesibles de terapia de luz roja. Usa tu criterio, lee los detalles del producto y habla con un profesional de salud si tienes síntomas persistentes o severos.",
    ...
    chatNoSessions: "Aún no tienes sesiones guardadas. Empieza con una entrada simple: zona del cuerpo, duración, distancia, dolor antes, dolor después y una nota sobre cómo se sintió sentarte o moverte.",
    ...
    chatLog: "Para una entrada útil, registra zona del cuerpo, duración, distancia, longitud de onda si la sabes, dolor antes y después, y una nota funcional: tolerancia al sentarte, detonantes, sueño, ejercicio o respuesta de la piel.",
    chatHow: "Empieza con una zona del cuerpo y mantén el protocolo constante por varias sesiones: mismo dispositivo, distancia similar, duración similar y puntuaciones honestas antes/después. La constancia hace más útil la gráfica.",
